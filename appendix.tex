...
\begin{figure}[p]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \includegraphics[
            ...
            trim=0 .2cm 0cm .2cm,
            clip
        ]{/home/adrian/PycharmProjects/decouple-composite/figures/review2/srf8r121.000000seed476613/foreground_merged.pdf}
        \caption{Foreground components after convolution with the representation kernel.}
        \label{fig:simple:fg}
    \end{subfigure}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \includegraphics[
            width=\linewidth
        ]{/home/adrian/PycharmProjects/decouple-composite/figures/review2/srf8r121.000000seed476613/backgrounds.pdf}
        \caption{Background components using the same parameters.}
        \label{fig:simple:bg}
    \end{subfigure}
