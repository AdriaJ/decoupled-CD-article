...
\begin{figure}[p]
    \centering
    \includegraphics[width=.91\linewidth, trim=0 .2cm 0cm .2cm,clip]{figures/review2/srf8r121.000000seed476613/foreground_merged.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=.91\linewidth, trim=0 .2cm 0cm .2cm,clip]{figures/review2/srf8r121.000000seed476613/backgrounds.pdf}
    \caption{Background components using the same parameters.}
    \label{fig:simple:bg}
\end{figure}
